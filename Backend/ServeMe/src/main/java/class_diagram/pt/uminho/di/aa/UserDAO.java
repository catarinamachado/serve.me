...
public class UserDAO {
	...
	public static User loadUserByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (User) session.load(class_diagram.pt.uminho.di.aa.User.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User getUserByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (User) session.get(class_diagram.pt.uminho.di.aa.User.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User loadUserByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (User) session.load(class_diagram.pt.uminho.di.aa.User.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User getUserByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (User) session.get(class_diagram.pt.uminho.di.aa.User.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryUser(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From class_diagram.pt.uminho.di.aa.User as User");
		if (condition != null)
	...
	public static User createUser() {
		return new class_diagram.pt.uminho.di.aa.User();
	}
	
	public static boolean save(class_diagram.pt.uminho.di.aa.User user) throws PersistentException {
		try {
			class_diagram.pt.uminho.di.aa.TutorialMDAPersistentManager.instance().saveObject(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(class_diagram.pt.uminho.di.aa.User user) throws PersistentException {
		try {
			class_diagram.pt.uminho.di.aa.TutorialMDAPersistentManager.instance().deleteObject(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(class_diagram.pt.uminho.di.aa.User user) throws PersistentException {
		try {
			class_diagram.pt.uminho.di.aa.TutorialMDAPersistentManager.instance().getSession().refresh(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(class_diagram.pt.uminho.di.aa.User user) throws PersistentException {
		try {
			class_diagram.pt.uminho.di.aa.TutorialMDAPersistentManager.instance().getSession().evict(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
