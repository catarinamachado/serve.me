...
public class PlatformDAO {
	public static Platform loadPlatformByORMID(int ID) throws PersistentException {
		try {
			PersistentSession session = class_diagram.pt.uminho.di.aa.TutorialMDAPersistentManager.instance().getSession();
	...
	public static Platform loadPlatformByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Platform) session.load(class_diagram.pt.uminho.di.aa.Platform.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Platform getPlatformByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Platform) session.get(class_diagram.pt.uminho.di.aa.Platform.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Platform loadPlatformByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Platform) session.load(class_diagram.pt.uminho.di.aa.Platform.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Platform getPlatformByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Platform) session.get(class_diagram.pt.uminho.di.aa.Platform.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryPlatform(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From class_diagram.pt.uminho.di.aa.Platform as Platform");
		if (condition != null)
	...
	public static Platform createPlatform() {
		return new class_diagram.pt.uminho.di.aa.Platform();
	}
	
	public static boolean save(class_diagram.pt.uminho.di.aa.Platform platform) throws PersistentException {
		try {
			class_diagram.pt.uminho.di.aa.TutorialMDAPersistentManager.instance().saveObject(platform);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(class_diagram.pt.uminho.di.aa.Platform platform) throws PersistentException {
		try {
			class_diagram.pt.uminho.di.aa.TutorialMDAPersistentManager.instance().deleteObject(platform);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(class_diagram.pt.uminho.di.aa.Platform platform) throws PersistentException {
		try {
			class_diagram.pt.uminho.di.aa.TutorialMDAPersistentManager.instance().getSession().refresh(platform);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(class_diagram.pt.uminho.di.aa.Platform platform) throws PersistentException {
		try {
			class_diagram.pt.uminho.di.aa.TutorialMDAPersistentManager.instance().getSession().evict(platform);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
