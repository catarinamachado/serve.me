...
public class UserDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public UserDetachedCriteria() {
		super(class_diagram.pt.uminho.di.aa.User.class, class_diagram.pt.uminho.di.aa.UserCriteria.class);
	...
	public UserDetachedCriteria(DetachedCriteria aDetachedCriteria) {
		super(aDetachedCriteria, class_diagram.pt.uminho.di.aa.UserCriteria.class);
		ID = new IntegerExpression("ID", this.getDetachedCriteria());
		name = new StringExpression("name", this.getDetachedCriteria());
		email = new StringExpression("email", this.getDetachedCriteria());
		password = new StringExpression("password", this.getDetachedCriteria());
