...
public class TutorialMDAPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "TutorialMDA";
	...
	private TutorialMDAPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new TutorialMDAPersistentManager();
		}
