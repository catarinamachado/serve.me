...
public class GameDAO {
	...
	public static Game loadGameByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Game) session.load(class_diagram.pt.uminho.di.aa.Game.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Game getGameByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Game) session.get(class_diagram.pt.uminho.di.aa.Game.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Game loadGameByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Game) session.load(class_diagram.pt.uminho.di.aa.Game.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Game getGameByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Game) session.get(class_diagram.pt.uminho.di.aa.Game.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryGame(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From class_diagram.pt.uminho.di.aa.Game as Game");
		if (condition != null)
	...
	public static Game createGame() {
		return new class_diagram.pt.uminho.di.aa.Game();
	}
	
	public static boolean save(class_diagram.pt.uminho.di.aa.Game game) throws PersistentException {
		try {
			class_diagram.pt.uminho.di.aa.TutorialMDAPersistentManager.instance().saveObject(game);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(class_diagram.pt.uminho.di.aa.Game game) throws PersistentException {
		try {
			class_diagram.pt.uminho.di.aa.TutorialMDAPersistentManager.instance().deleteObject(game);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(class_diagram.pt.uminho.di.aa.Game game) throws PersistentException {
		try {
			class_diagram.pt.uminho.di.aa.TutorialMDAPersistentManager.instance().getSession().refresh(game);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(class_diagram.pt.uminho.di.aa.Game game) throws PersistentException {
		try {
			class_diagram.pt.uminho.di.aa.TutorialMDAPersistentManager.instance().getSession().evict(game);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
