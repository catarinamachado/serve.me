...
public class PrestadorDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public utilizador.Avaliacao_PrestadorDetachedCriteria createAvaliacoesCriteria() {
		return new utilizador.Avaliacao_PrestadorDetachedCriteria(createCriteria("ORM_Avaliacoes"));
	}
